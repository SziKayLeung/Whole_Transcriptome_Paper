...
refine2fasta(){
  ...
  minimap2 -t 30 -ax splice -uf --secondary=no -C5 -O6,24 -B4 $REFERENCE/hg38.fa All_flnc.fasta > All.sam 2> All.map.log
  samtools sort -O SAM All.sam > All.sorted.sam
  python $CUPCAKE/sam_to_gff3.py All.sorted.sam -i All_flnc.fasta -s hg38
}
