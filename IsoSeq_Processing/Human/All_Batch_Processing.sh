...
SAMPLES_NAMES=(AdultCTX1 AdultCTX2 AdultCTX3 AdultCTX4 AdultCTX5 FetalCTX1 FetalCTX2 FetalCTX3 FetalCTX4 FetalCTX5 FetalHIP1 FetalHIP2 FetalSTR1 FetalSTR2)
cd $FUNCTIONS
cat All_Human_RawData.txt
# remove comments in raw.txt (https://kvz.io/blog/2007/07/11/cat-a-file-without-the-comments/)
BAM_FILES=(`cat "All_Human_RawData.txt" | egrep -v "^\s*(#|$)"`)
